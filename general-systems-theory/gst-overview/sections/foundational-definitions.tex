...
Bunge introduces environmental considerations into the system definition \citep{Bunge1979}. Given a nonempty set $T$, an ordered triple $W = (C, E, S)$ constitutes a system over $T$ if and only if:
