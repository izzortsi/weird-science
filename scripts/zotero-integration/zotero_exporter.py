...
def main():
    ...
    print("\nStep 4: Generating knowledge base...")
    if not args.dry_run and zotero_items:
        kb_dir = args.repo_root / 'knowledge-database'
        MarkdownGenerator.generate_knowledge_base(
            zotero_items, kb_dir, args.group_id
        )
