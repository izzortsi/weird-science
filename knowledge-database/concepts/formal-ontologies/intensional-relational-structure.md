...
1. **Family Domain**: An intensional relational structure for family relationships might include:
   - Conceptual categories: Person
   - Conceptual relations: parent-of, sibling-of, spouse-of
   - This defines what we mean by family relationships without specifying actual people

2. **Organizational Domain**: The conceptual structure might include:
   - Categories: Employee, Department, Role
   - Relations: works-in, reports-to, manages
   - These concepts exist at the schema level, independent of any particular organization

## Key References

The concept of intensional relational structure is central to Gruber's formalization of ontologies and conceptualizations, where it forms part of the theoretical foundation distinguishing between:
- The conceptual level (intensional)
- The logical level (ontological commitment)
- The instance level (extensional models)
