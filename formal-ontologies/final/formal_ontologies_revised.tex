...
\newcommand{\ctitleshort}{Expanding Formal Ontologies}
...
\newcommand{\maketitlecustom}{
	...
	\begin{center}
		...
		{\Large \instituto} \\ [0.15cm]
		{\large \textit{\departamento}} \\[0.5cm]
		...
		\vspace{0.8cm}
%		\begin{tabular}{ll}
		{\large \textit{Work developed for the course:} \disciplina{Projeto I (MAEX11)}} \\ [0.25cm]
		{\large \textit{Supervisor:} \professor} \\
%		\end{tabular}
	\end{center}
	\vspace{0.5cm}
	\hrule height 1pt
